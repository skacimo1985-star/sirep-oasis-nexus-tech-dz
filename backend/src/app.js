...
app.get('/health', (_req, res) => {
  res.json({ status: 'ok', timestamp: new Date(), service: 'sirep-nexus-backend', version: '1.0.0' });
});
...
const corsOrigins = Array.isArray(config.CORS_ORIGINS) ? config.CORS_ORIGINS : [config.CORS_ORIGINS];
